/**
 * ZIVO — COMMUNITY (placeholder)
 * ---------------------------------------------------------------
 * A stand-in so the bottom bar has something to show. Crews, clips and player profiles land here later.
 */
...
export default function Community() {
  ...
  return (
    <View style={[styles.screen, { paddingTop: insets.top + 24 }]}>
      <Ionicons name="people" size={34} color="#FFC529" />
      <Text style={styles.title}>COMMUNITY</Text>
      <Text style={styles.sub}>Players, crews and clips</Text>
      <Text style={styles.body}>Crews, clips and player profiles land here later.</Text>
