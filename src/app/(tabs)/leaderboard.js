/**
 * ZIVO — LEADERBOARD (placeholder)
 * ---------------------------------------------------------------
 * One of the 5 tabs. The full ranking board goes here:
 * daily / weekly / all-time, your own position highlighted.
 *
...
export default function Leaderboard() {
  ...
  return (
    <View style={[styles.screen, { paddingTop: insets.top + 24 }]}>
      <Ionicons name="podium-outline" size={38} color="#FFC529" />
      <Text style={styles.title}>LEADERBOARD</Text>
      <Text style={styles.sub}>Daily · Weekly · All time</Text>
      <Text style={styles.body}>
        Who dey win the most, how much XP dem don chop, and where YOU stand among them.
      </Text>
